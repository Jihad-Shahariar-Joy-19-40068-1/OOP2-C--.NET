...
namespace ChefsFoodManagement.Presentation_Layer
{
    public partial class ManageFood : Form
    {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            {
                FoodDataAccess foodDataAccess = new FoodDataAccess();
                if (addQuantityTextBox.Text.All(Char.IsNumber) == true && addPerUnitPriceTextBox.Text.All(Char.IsNumber) == true)
                {
                ...
                {
                    MessageBox.Show("Invalid Input Quantity \nOtherwise Invalid Input in PerUnit Price");
                    //ClearFields();
                }
            }
        }
        ...
        private void viewChartButton_MouseHover(object sender, EventArgs e)
        {
            viewChartButton.BackColor = Color.DeepSkyBlue;
        }

        private void viewChartButton_MouseLeave(object sender, EventArgs e)
        {
            viewChartButton.BackColor = Color.Transparent;
        }
